...
def create_googlenet(input_shape=(3,224,224), n_classes=10, weights_path=None):
    ...
    loss3_classifier = Dense(n_classes, name='loss3/classifier',W_regularizer=l2(0.0002))(pool5_drop_7x7_s1)
